...
RUN apk update && \
    ...
    apk add php7 php7-apache2 php7-gd php7-pdo_mysql php7-json php7-xml php7-mbstring php7-session php7-curl php7-simplexml php7-ctype php7-dom php7-iconv php7-xmlwriter php7-tokenizer && \
